...
<head>
<meta charset="utf-8"/>
<title>Thesis #20. Hybrid occult mode switches under partial observers</title>
<style>
@page {{
  size: A4;
  margin: 22mm 20mm 24mm 20mm;
  @bottom-center {{
    content: "Ogbonna KE. Thesis #20. Computational research only. Not a medical device. " counter(page);
    font-size: 8.5pt;
    color: #444;
